        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r  dark:group-data-[side=left]:border-r-slate-800  group-data-[side=right]:border-l",
            className
          )}
          {...props}
        >
